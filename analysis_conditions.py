...
p2 = sns.histplot(data=analysis_data1, x="state", stat='percent', hue='state')
...
p3 = sns.histplot(data=analysis_data2, x='displacements', stat='percent', hue='state', bins=number_of_bins, kde=True)
